...
#
# The files in the {basebox-dir}/database/backups/ directory should be created by
...
# `db_name` matches the name of a database already created in {basebox-dir}/database/init-custom.sql
# or {basebox-dir}/database/init.sql.
#
...
# through {basebox-dir}/database/data
#
# Let's begin...
